...
!function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</span>');
            html.push('<span>，<span>跳转到 </span><input id="jumpVal" type="text" class="form-control" style="width: 60px;display: inline-block;text-align: center;" placeholder="页数">');
            html.push(' <button id="confirmJump" class="btn btn-default btn-sm">跳转</button></span>');
            // TODO
            // this.selectPage(2);
            // console.log($('#confirmJump'));
            // $('#confirmJump').onclick = function () {
            //   alert(1);
            // }
            //
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            $jump = this.$pagination.find('#confirmJump');
